...
const pages = [
  ...
  {
    path: "pages/forum_article/list",
    style: {
      navigationBarTitleText: "长文列表"
    }
  },
  {
    path: "pages/forum_like/list",
    style: {
...
const globalStyle = {
  ...
  navigationBarBackgroundColor: "#0192F3",
  backgroundColor: "#F8F8F8"
};
const tabBar = {
  color: "#888",
  selectedColor: "#0192F3",
  list: [
    {
...
const uniIdRouter = {
  ...
  needLogin: [
    ...
    "pages/self/self",
    "pages/detail/detail",
    "pages/forum_article/list",
    "pages/forum_like/list",
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{"address":["127.0.0.1","192.168.92.1","192.168.244.1","192.168.43.96"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Program Files/HBuilderX/plugins/unicloud/**/*.js"]}'), T = I('[{"provider":"aliyun","spaceName":"alidemo","spaceId":"mp-14fbc64a-651b-45d0-9ccc-da3177a14322","clientSecret":"gJ7jSuDrG7aMag3dLZsxsQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__B43C8B1";
} catch (e2) {
