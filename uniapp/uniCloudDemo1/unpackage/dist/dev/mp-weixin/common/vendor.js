...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__8C0AA39",
    appName: "uniCloudDemo1",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/demo-user/list",
    style: {
      navigationBarTitleText: "列表"
    }
  },
  {
    path: "pages/demo-user/add",
    style: {
      navigationBarTitleText: "新增"
    }
  },
  {
    path: "pages/demo-user/edit",
    style: {
      navigationBarTitleText: "编辑"
    }
  },
  {
    path: "pages/demo-user/detail",
    style: {
