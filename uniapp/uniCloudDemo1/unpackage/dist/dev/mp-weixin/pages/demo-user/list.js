...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "88ff29fa-2-" + i0 + "-" + i1 + "," + ("88ff29fa-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "88ff29fa-1-" + i0 + ",88ff29fa-0"
      } : {}, {
        c: data,
        g: "88ff29fa-3-" + i0 + ",88ff29fa-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "88ff29fa-0"),
    c: common_vendor.p({
      collection: $data.collectionList,
      field: "name,age,gender"
    }),
    d: common_vendor.sr("fab", "88ff29fa-4"),
