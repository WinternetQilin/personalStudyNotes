      ...
      const draw = () => {
        ...
        ctx.draw(false, () => {
          ...
          let params = {
            ...
            fail: (error) => {
              common_vendor.index.__f__("error", "at uni_modules/uni-id-pages/pages/userinfo/cropImage/limeClipper/limeClipper.vue:782", "error", error);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    C: $props.isShowConfirmBtn
  }, $props.isShowConfirmBtn ? common_vendor.e({
    D: _ctx.$slots.confirm
  }, _ctx.$slots.confirm ? {} : {}, {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-5dd2a2ff"]]);
